...
class MulGAN():
    ...
    def interpolate(self, interpolator, freq=2, batch_size=8):
        out_length = (self.nimages - 1) * freq
        interpolated_noises = interpolator(self.rec_input_noises[0], freq, self.device)
    ...
    def linear_interpolate(self, freq=2, batch_size=8):
        return self.interpolate(linear_interpolator, freq, batch_size)
    ...
    def linear_mean_std_interpolate(self, freq=2, batch_size=8):
        return self.interpolate(linear_mean_std_interpolator, freq, batch_size)
